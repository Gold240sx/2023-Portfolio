    ...
    return (
        <div>
            ...
            <div className="fixed top-0  left-0 right-0 bottom-0  h-[100vh] w-full items-center justify-between blur-xl">
                ...
                <div className="absolute  top-[90%] left-1/2 bottom-0  h-[400px] w-[550px] scale-[300%] opacity-100 transition-all duration-1000 ease-in-out   dark:opacity-[20%]">
                    <svg
                        viewBox="0 0 200 200"
                ...
                <div className="duration-2000 absolute -right-24 mt-[20%] h-[80vh] w-[60vh] scale-[150%] opacity-100 transition-all ease-in-out dark:opacity-[20%]">
            ...
            <section
                id="hero-container"
                className="max-w-screen container z-10 m-auto mt-8 flex h-screen w-screen justify-center align-middle dark:bg-transparent"
