            ...
            <div className="pointer-events-none absolute z-10 h-full  w-[120%]">
                ...
                {selectedTab === "College" && (
                    <img
                        ...
                        alt="background-decoration"
                        className={`${
                            mode === "dark" ? "opacity-5" : "opacity-[25%]"
                ...
                {selectedTab === "Continued Education / Certificates" && (
                    <img
                        ...
                        alt="background-decoration"
                        className={`${
                            mode === "dark" ? "opacity-[5%]" : "opacity-[10%]"
                        } -z-1  hue-rotate-45 left-0 h-fit w-[400%] -translate-y-[400px] translate-x-24 scale-[3] object-cover saturate-200 md:scale-150`}
                    />
                )}
                                        ...
                                        <div className=" hidden h-fit max-w-full md:-ml-4 lg:flex">
                                            {selectedTab ===
                                                ...
                                                <motion.div
                                                    ...
                                                    className="flex w-auto flex-col md:flex-row"
                                                >
                                                    <motion.img
                                                        src={ContinuedNeon}
