...
const Timeline = () => {
    ...
    return (
        <div className="relative mx-auto flex h-fit  w-auto max-w-screen-xs  flex-col items-center justify-evenly text-center sm:max-w-screen-sm sm:px-4 md:max-w-7xl md:text-left">
            ...
            <div className=" left-0 right-0 bottom-0 z-0 mx-auto flex origin-top-right skew-y-[11deg] transform rounded-lg bg-zinc-200 pt-16 dark:bg-slate-800 md:skew-y-0">
                <div
                    id="lineup-container"
                    className="relative mt-2 -skew-y-[11deg] rounded-lg bg-zinc-200 px-2 py-4 pb-10 ring-offset-accent-focus dark:bg-slate-800 dark:text-zinc-200 md:skew-y-0"
                >
