        ...
        <div className=" flex h-full w-full items-center justify-center rounded-lg p-4">
            <div className="flex w-auto flex-col  gap-4 md:flex-row">
                ...
                <div className="flex flex-col items-start justify-start md:max-w-[50%]">
                    ...
                    />
                    {/* tags */}
                    <div className=" mt-2 mr-auto flex flex-col justify-start align-baseline md:flex-row">
                        <h4 className=" mx-2 justify-start text-lg font-medium line-clamp-1">
                            TAGS:
                        </h4>
                ...
                <div className="flex w-full flex-col items-start justify-start">
                    ...
                    <div className="my-4 flex w-auto justify-start gap-2">
                        <h2 className="cursor-pointer text-left ">
                            <a
                                href={link}
                                className="rounded-full bg-sky-400 px-5 py-1 text-white"
                            >
                                Link
                            </a>
                        </h2>
                    ...
                    <div className="flex overflow-ellipsis">
                        <h4 className="align-center my-2 flex h-8 justify-center p-[2px] text-center text-lg font-medium ">
                            TECH:
                        </h4>
...
const Projects = () => {
    ...
    return (
        <div className="relative mx-auto flex h-fit flex-col items-center justify-evenly text-center md:text-left lg:px-10">
            ...
            <div className="w-full rounded-lg bg-white dark:bg-gray-800 md:p-4">
                ...
                <hr className="relative mx-4 -mt-4  h-2 w-auto rounded border-0 bg-gradient-radial from-sky-400 via-cyan-600 to-teal-600 fill-black" />
                {/* Project Cards */}
