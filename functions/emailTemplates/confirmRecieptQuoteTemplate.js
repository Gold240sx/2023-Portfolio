    ...
    return {
        ...
        <html xmlns="http://www.w3.org/1999/xhtml" lang="en">
            ...
            <center style="width: 100%; table-layout: fixed; background-color: #f6f9fc; padding-bottom: 40px">
                <div style="max-width: 600px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.2) ; border: 2px; border-color: #0fb4cc; ; background-color: #1d1d1d;">
                    ...
                    <table
                                                ...
                                                <tr>
                                                    <td
                                                        style="
                                                            ...
                                                            width: 220px;
                                                        ">
                                                        <a href="https://www.michael-martell.co.com"
                                                            ><img
                                                ...
                                                <tr>
                                                    <td
                                                        ...
                                                        <a href="https://www.michael-martell.com">
                                                            <img
                                                                id="site-logo"
                                                                src="https://i.ibb.co/6r6jTmH/mac.png"
                                                                alt="mac"
                                                                width="50"
                        ...
                        <tr>
                            ...
                            <td
                                id="banner"
                                class="banner"
                                background="https://i.ibb.co/YkS6BSc/GetQuote.gif"
                                width="600"
                                height="380"
                                style="
                                    ...
                                    <tr class="top">
                                        <td
                                            ...
                                            <span>
                                                <!-- 										background-color: #ea2c5f;
                                                                            border: 1px solid #E6507D; -->
                                            <strong style="color: #0094ab; line-height: 26px; font-size: 16px">
                                                Thank you for your interest in my web and mobile app development services! </strong
                                            ><br />
                                            <span
                                                style="
                                                    font-size: 15px;
                                                    ...
                                                    text-indent: 30px;
                                                ">
                                                I appreciate you taking the time to contact me. To help me better understand your project and your
                                                specific requirements, please feel free to provide me with any additional details, images or details
                                                that you would like to further discuss regarding your project via replying to this email. This will help 
                                                me provide you with an accurate quote and a proposal that meets your specific needs. <br /><br />
                                                <strong style="margin-left: 15px; color: rgb(177, 177, 177); font-size: 17px">
                                                    If not previously provided, helpful information includes:
                                                </strong> 
                                            </span>
                                            </p>
                                        </td>
                                    </tr>
                                    <table class="middle" align="center" width="80%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                        <tr>
                                            <td
                                                class="padding content"
                                                style="padding-right: 20px; padding-left: 20px; width: 80%; text-align: left; font-size: 20px">
                                                <p
                                                    style="
                                                        font-size: 17px;
                                                        line-height: 22px;
                                                        ...
                                                        gap: 10px;
                                                    ">
                                                    1. A description of the function / purpose of the website or app are you looking to build? <br /> <br />
                                                    2. Do you require design services as well as development, or do you already have the design ready? <br /> <br />
                                                    3. Any interactive features and functionality would you like to include? Site / email / payments / other <br /> <br />
                                                    4. Do you have any specific design or branding requirements? <br /> <br />
                                                    5. What is your budget and timeline for the project? <br /> <br />
                                                    6. (If website): Will your site require authentication? Security rules? API calls to external data or databases <br /> <br />
                                                    7. Will the data provided to your website or app be connected to a database? <br /> <br />
                                                    8. Will you need data Integration with CRMS or cross platform functionality? <br /> <br />
                                                </p> 
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <td
                                            ...
                                            <p
                                                style="
                                                    ...
                                                    line-height: 23px;
                                                ">
                                                With this information from you, I will be able to provide you with a more detailed and comprehensive
                                                quote that outlines the scope of the project, my approach, and the cost. Thank you for considering
                                                my services, and I look forward to hearing back from you soon!
                                            </p>

                                            <table align="center" border="0" cellspacing="0" cellpadding="0" role="presentation" style=" margin-bottom: 40px;">
                                                <tr>
                            ...
                            <div style="display:flex;height:fit-content;width:auto;flex-direction:column;border-width:2px;border-color:rgb(161,161,170);padding-left:0.75rem;padding-right:0.75rem; ">
                                ...
                                <table class="darkmode-transparent" style="table-layout:auto;border-radius:0.75rem;border-color:rgb(96, 96, 96); background-color: rgb(177, 177, 177); margin-bottom: 20px; padding-bottom: 20px; border:2px">
                                    ...
                                    <tbody style="text-align:center;color:rgb(161,161,170); margin-left: 20px; margin-right: 20px;">
                                        <tr>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem;font-weight:600;color:rgb(113,113,122)">Contact Type:</td>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem">${contactType}</td>
                                        </tr>
                                        <tr>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem;font-weight:600;color:rgb(113,113,122)">Date:</td>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem">${date}</td>
                                        </tr>
                                        <tr>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem;font-weight:600;color:rgb(113,113,122)">Project Name:</td>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem">${projectName}</td>
                                        </tr>
                                        <tr>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem;font-weight:600;color:rgb(113,113,122)">Project Type:</td>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem">${projectType}</td>
                                        </tr>
                                        <tr>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem;font-weight:600;color:rgb(113,113,122)">Contact Name:</td>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem">${contactName}</td>
                                        </tr>
                                        <tr>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem;font-weight:600;color:rgb(113,113,122)">Email:</td>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem">${email}</td>
                                        </tr>
                                        <tr>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem;font-weight:600;color:rgb(113,113,122)">Deadline:</td>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem">${deadline}</td>
                                        </tr>
                                        <tr>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem;font-weight:600;color:rgb(113,113,122)">Message:</td>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem"> ${message}</td>
                                        </tr>
                                    </tbody>
                                </table>
                                                        ...
                                                        <table
                                                            ...
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    <a href="https://www.example.com"
                                                                        ><img
                                                                            src="https://i.ibb.co/M6WP8Xy/w3newbie-white.png"
                                                                            alt="footer logo"
                                                                            width="160"
