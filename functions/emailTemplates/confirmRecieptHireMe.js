function confirmRecieptHireMe(formData) {
    const {
        contactType,
        date,
        recievedDateandTime,
                    ...
                    <table
                        ...
                        <tr>
                            ...
                            <td
                                id="banner"
                                class="banner"
                                background="https://i.ibb.co/pd22Z3c/HireMe.gif"
                                width="600"
                                height="380"
                                style="
                                    ...
                                    <tr class="top">
                                        <td
                                            ...
                                            <strong style="color: #f27f14; line-height: 26px; font-size: 16px; ">
                                                Thank you for expressing interest in an employment or hiring opportunity! </strong
                                            ><br />
                                            <span
                                                style="
                                                    font-size: 15px;
                                                    ...
                                                    text-indent: 30px;
                                                ">
                                                I am honored that you have considered me for this opportunity.
                            ...
                            <div style="display:flex;height:fit-content;width:auto;flex-direction:column;border-width:2px;border-color:rgb(161,161,170);padding-left:0.75rem;padding-right:0.75rem; ">
                                ...
                                <table class="darkmode-transparent" style="table-layout:auto;border-radius:0.75rem;border-color:rgb(96, 96, 96); background-color: rgb(177, 177, 177); margin-bottom: 20px; padding-bottom: 20px; border:2px">
                                    ...
                                    <tbody style="text-align:center;color:rgb(161,161,170); margin-left: 20px; margin-right: 20px;">
                                        ...
                                        <tr>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem;font-weight:600; text-align: right; color:rgb(113,113,122)">Company:</td>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem; text-align: left;">${company}</td>
                                        </tr>
                                        <tr>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem;font-weight:600; text-align: right; color:rgb(113,113,122)">Contact Name:</td>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem; text-align: left;">${contactName}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem;font-weight:600; text-align: right; color:rgb(113,113,122)">Position:</td>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem; text-align: left;">${position}</td>
                                        </tr>
                                        <tr>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem;font-weight:600; text-align: right; color:rgb(113,113,122)">Custom Position:</td>
                                            <td style="border-width:1px;padding-left:1rem;padding-right:1rem;padding-top:0.5rem;padding-bottom:0.5rem; text-align: left;">${customPosition}</td>
                                        </tr>
                                        <tr>
...
module.exports = confirmRecieptHireMe
